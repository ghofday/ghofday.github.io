...
var hearts = 0;
var gonele = false;
var endDate = new Date("May 1, 2021 00:00:00").getTime();
var timer = setInterval(function() {
    ...
    if (t >= 0) {
       ...
       document.getElementById('timer-hours').remove();
       document.getElementById('timer-mins').remove();
       document.getElementById('timer-secs').remove();
       document.getElementById('timer-days').innerHTML = "I miss you so much <3 I hope your days are treating you well, here is your reminder that you are more than enough and you deserve everything good! I LOVE YOU SO MUCHIE!!";
...
function switchbonus(){
  ...
  document.getElementById('lastlast').style.visibility = 'visible';
  document.getElementById('second').style.opacity = 0;
  setTimeout(pinkworld, 2000);
}
...
function cptwo() {
 ...
 function boopletter() {
document.getElementById('bonusmenu').style.visibility = 'hidden';
document.getElementById('lastlast').style.visibility = 'hidden';
document.getElementById('second').style.opacity = 0;
setTimeout(ily6, 2000);
 }
